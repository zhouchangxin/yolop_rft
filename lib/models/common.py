    ...
    def __init__(self, inplanes, planes, kernel_size=3, stride=1, downsample=None, act=True):
        ...
        self.depthwise = nn.Sequential(
            nn.Conv2d(inplanes, inplanes, kernel_size, stride=stride,
                      groups=inplanes, padding=kernel_size//2, bias=False),
...
class Conv(nn.Module):
    # Standard convolution[32, 64, 3, 2]
    # ch_in, ch_out, kernel, stride, padding, groups
...
class SPP(nn.Module):
    # Spatial pyramid pooling layer used in YOLOv3-SPP [512, 512, [5, 9, 13]]
